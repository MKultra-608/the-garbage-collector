...
export const ENEMIES: Record<string, EnemySpec> = {
  crumple: {
    ...
    sprite: CRUMPLE,
    moves: [
      { name: 'Paper Cut', msg: 'CRUMPLE slices with a folded edge!', dmg: [3, 5], weight: 3 },
  ...
  lintgolem: {
    ...
    sprite: LINT_GOLEM,
    moves: [
      { name: 'Lint Barrage', msg: 'LINT GOLEM hurls compacted fluff!', dmg: [4, 7], weight: 3 },
  ...
  sludgecone: {
    ...
    sprite: SLUDGE_CONE,
    moves: [
      { name: 'Ooze Splash', msg: 'SLUDGE CONE splashes expired coffee ooze!', dmg: [5, 8], weight: 3 },
  ...
  shredling: {
    ...
    sprite: SHREDLING,
    moves: [
      { name: 'Paper Storm', msg: 'SHREDLING flings a blizzard of confetti!', dmg: [5, 8], weight: 3 },
  ...
  junkfax: {
    ...
    sprite: JUNK_FAX,
    moves: [
      { name: 'Cover Sheet', msg: 'JUNK FAX spools endless cover sheets at you!', dmg: [6, 9], weight: 3 },
  ...
  mislabel: {
    ...
    moves: [
      { name: 'Return to Sender', msg: 'MISLABEL hurls itself shoulder-first!', dmg: [8, 12], weight: 1 },
      { name: 'Relabel', msg: 'MISLABEL slaps on a fresh FRAGILE sticker and braces.', self: 'guard', weight: 1 },
      { name: 'Postage Due', msg: 'MISLABEL dumps a sack of unpaid postage on you!', dmg: [10, 14], weight: 1 },
    ],
  ...
  tallymore: {
    ...
    sprite: TALLYMORE,
    moves: [
      { name: 'Add One', msg: 'TALLYMORE scratches another mark and swells!', dmg: [6, 9], weight: 3 },
  ...
  rolo: {
    ...
    sprite: ROLO,
    moves: [
      { name: 'Spin Cycle', msg: 'ROLO whirls its cards into a buzzsaw!', dmg: [7, 10], weight: 3 },
  ...
  offbyone: {
    ...
    moves: [
      { name: 'Index n', msg: 'OFF-BY-ONE files a drawer squarely into you!', dmg: [9, 13], weight: 1 },
      { name: 'Recount', msg: 'OFF-BY-ONE counts again from zero. Its total rises!', self: 'atk+', weight: 1 },
      { name: 'Overrun', msg: 'OFF-BY-ONE reaches for index n+1 that is not there — and slams it anyway!', dmg: [12, 16], weight: 1 },
    ],
  ...
  copypasta: {
    ...
    sprite: COPYPASTA,
    moves: [
      { name: 'Paste Slam', msg: 'COPYPASTA slams you with sixty identical pages!', dmg: [7, 11], weight: 3 },
  ...
  scopecreep: {
    ...
    sprite: SCOPE_CREEP,
    moves: [
      { name: 'Spill Over', msg: 'SCOPE CREEP surges over its partition and onto you!', dmg: [8, 12], weight: 3 },
  ...
  stackoverflow: {
    ...
    moves: [
      { name: 'Push Frame', msg: 'STACK OVERFLOW drops a loaded tray on you!', dmg: [10, 14], weight: 1 },
      { name: 'Self Call', msg: 'STACK OVERFLOW stacks another copy of itself. It looms taller!', self: 'atk+', weight: 1 },
      { name: 'Deep Stack', msg: 'The whole tower lurches and slams down across you!', dmg: [13, 18], weight: 1 },
    ],
