/**
 * Built-in 5x7 bitmap font (classic dot-matrix style), full printable ASCII.
 * Each glyph is 7 rows of 5 bits, MSB = leftmost pixel.
 * This is the ONLY font in the game — everything (dialogue, menus, the C++
 * editor) renders through it, which keeps the pixel aesthetic coherent.
 */
